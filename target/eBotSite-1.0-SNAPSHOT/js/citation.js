...
function createTextBox(name, label, hint, number, important = false, pattern = '.*') {
    return "<div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label textFieldStyle\"\n" +
        ...
        "<div>" +
        "        <label class=\"mdl-textfield__label\" for=\"" + name + "-textBox\"" + (important ? "style=\"color: #002171\"" : "\"") + ">" + label + "</label>\n" +
        "        <label class=\"mdl-textfield__label\" for=\"" + name + "-textBox\" style=\"text-align: right;font-size: small;" + (important ? " color: #002171" : "") + "\">(" + number + ")</label>" +
        "</div>" +
        "<div class=\"mdc-text-field-helper-line\" ><span\n" +
        "class=\"mdc-text-field-helper-text mdc-text-field-helper-text--persistent mdc-text-field-helper-text--validation-msg oversizeStyle\"\n" +
        "        >" + hint + "</span>\n" +
        "    </div>" +
        "            </div>";
}
...
function createResultField() {
    return "<div class=\"mdc-chip\" role=\"row\"\n" +
        ...
        "            <span class=\"oversizeStyle\" role=\"gridcell\"\n" +
        "                  style=\"outline: none;max-width: 100%\">\n" +
        "                    <span id=\"result\" tabindex=\"0\" class=\"mdc-chip__text\" style=\"outline: none\" onmouseover=\"reset()\"\n" +
        ...
        "        <br> <br> <br> <br>\n" +
        "        <div>\n" +
        "            <a href=\"#\" class=\"mdc-button mdc-button--outlined\" onclick=\"clearAll()\"\n" +
...
function clearAll() {
    for (var i = 0; i < list.length; i++) {
        ...
        list[i].parentNode.classList.remove("is-invalid");
    }
